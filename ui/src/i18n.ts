...
const ENGLISH_PHRASES: Record<string, string> = {
  ...
  '当前奇美拉队伍未选满；请先在游戏内选满策略组保存的五名英雄': 'The Chimera team is incomplete. Select the five champions saved in this strategy group first',
  '当前六头蛇队伍未选满；请先在游戏内选满六名英雄': 'The Hydra team is incomplete. Select all six champions in the game first',
  '当前队伍只选择了部分英雄，拒绝自动覆盖': 'The current team is only partially selected; automatic replacement was refused',
  ...
  '六头蛇已用策略组保存的六人队伍重新进入手动战斗': 'Hydra restarted in manual mode with the six champions saved in the strategy group',
  ...
  '至少需要一条策略规则': 'At least one strategy rule is required',
