...
const ENGLISH_PHRASES: Record<string, string> = {
  ...
  '提前重整条件': 'Early Regroup Conditions',
  '按回合与试炼设置': 'Set by turn and trials',
  '仅在指定回合仍有指定试炼未完成时触发': 'Trigger only when selected trials remain incomplete at the specified turn',
  '奇美拉提前重整条件': 'Chimera Early Regroup Conditions',
  '到达你指定的 Boss 回合后，仅在所选试炼仍未完成时重整并重新开战；可选择当前难度的任意试炼。': 'At the chosen Boss turn, regroup and restart only if the selected trials remain incomplete; any trial from the current difficulty can be selected.',
  '当前难度暂无可用试炼': 'No Trials Available for This Difficulty',
  '请等待本轮试炼数据完成读取': 'Wait for the current trial data to finish loading',
  '尚未设置提前重整': 'No Early Regroup Conditions',
  '不设置时仍沿用试炼已不可能完成与结算页重整': 'Without these conditions, impossible-trial and result-screen regroup behavior remains active',
  'Boss 回合达到': 'Boss Turn Reaches',
  '未完成关系': 'Incomplete Trial Logic',
  '任一所选试炼未完成': 'Any Selected Trial Is Incomplete',
  '全部所选试炼未完成': 'All Selected Trials Are Incomplete',
  '添加重整条件': 'Add Regroup Condition',
  '应用条件': 'Apply Conditions',
  '可从当前难度全部试炼中选择': 'Choose from all trials in the current difficulty',
  '等待本轮试炼数据': 'Waiting for Current Trial Data',
